      ...
      <div className="max-w-7xl mx-auto px-4 xl:px-6 flex items-center justify-between gap-3">
        ...
        <a href="#home" onClick={(e) => handleNavClick(e, 'home')} id="nav-brand-logo" className="flex items-center gap-2.5 xl:gap-3.5 group select-none shrink-0">
          ...
          <div className="flex flex-col">
            <span className="font-['Helvetica_Neue',_sans-serif] font-extrabold text-[22px] lg:text-[23px] tracking-tight leading-none text-white whitespace-nowrap">
              METALOWORLD
            </span>
            <span className="text-[10.5px] uppercase tracking-[0.3em] font-bold text-[#B8C4D0]/70 mt-1 whitespace-nowrap">
        ...
        <div className="hidden lg:flex items-center gap-3 xl:gap-4 shrink-0">
          ...
          <a
            ...
            className="px-2 xl:px-3 py-2 border border-emerald-500/30 text-emerald-400 bg-emerald-500/10 hover:bg-emerald-500 hover:text-white text-[10px] xl:text-xs font-bold uppercase tracking-wider transition-all duration-300 flex items-center gap-1.5 rounded shrink-0 whitespace-nowrap"
          >
